   ...
   sessionStorage.setItem("age",Response.data["age"]);
    ...
    render() {
        ...
        function loadSelf()
        {
             ...
             ugmail= sessionStorage.getItem("gmail");
            upassword= sessionStorage.getItem("password");
             umobo= sessionStorage.getItem("mobo");
             umobo2= sessionStorage.getItem("mobo2");
             uaddr= sessionStorage.getItem("addr");
             ucity= sessionStorage.getItem("city");
             udistrict= sessionStorage.getItem("district");
             uadno= sessionStorage.getItem("adno");
              ubdate= sessionStorage.getItem("bdate");
              uage= sessionStorage.getItem("age");
        };loadSelf();
